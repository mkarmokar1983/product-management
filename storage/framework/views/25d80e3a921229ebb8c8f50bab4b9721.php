            ...
            <div class="showFormContainer">
                ...
                <div class="">
                    <form class="showFormContent" action="<?php echo e(route('product.store')); ?>" method="POST">
                        ...
                        <div>
                            <input type="text" name="product_id" value="<?php echo e(old('product_id')); ?>" placeholder="Enter Product ID">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <input type="text" name="description" value="<?php echo e(old('description')); ?>" placeholder="Enter Product Description">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <input type="text" name="stock" value="<?php echo e(old('stock')); ?>" placeholder="Enter Product Stock Quantity">
