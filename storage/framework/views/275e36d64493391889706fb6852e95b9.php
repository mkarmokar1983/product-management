    ...
    <div class="bodyContainer">
        ...
        <div class="showForm">
            <div class="showFormContainer">
                ...
                <form class="showFormContent" action="<?php echo e(route('product.update', $product->id)); ?>" method="POST"
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <span class="validationMsg"><?php echo e($message); ?></span>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <img style="height: 34px; width:60px; border: 1px solid white; border-radius:4px"
                        src="<?php echo e(asset('./product-image/' . $product->image)); ?>" alt="No Img">
...
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\product-management\resources\views/edit.blade.php ENDPATH**/ ?>